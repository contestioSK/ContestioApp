                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Input
                              ...
                              className="pl-9 bg-slate-950 border-slate-800 focus:border-orange-500 text-white h-12 rounded-xl [color-scheme:dark]"
                            />
                          </div>
