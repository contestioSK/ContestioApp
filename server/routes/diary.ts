...
import { z } from "zod";
import { canUseFeature, validatePlanConstraints } from "@shared/plan-capabilities";
...
import {
  diaryBattles, diaryCatches, users, baitManufacturers, baitProductLines, baitFlavors,
  userArsenalBaits, userBadges, fishingAreas, friendships, equipmentManufacturers,
  equipmentCategories, equipmentProducts, userArsenalEquipment, insertUserArsenalEquipmentSchema,
  userBaitBrands, userBaitFlavors, insertUserBaitBrandSchema, insertUserBaitFlavorSchema,
  insertDiaryBattleSchema, insertSeasonGoalSchema, updateSeasonGoalSchema, insertUserArsenalBaitSchema,
} from "@shared/schema";
import {
...
export function registerDiaryRoutes(app: Express, helpers: {
  upload: multer.Multer;
  getUserId: (req: any) => string;
  broadcastToUsers: (userIds: string[], data: any) => void;
  notificationService: NotificationService;
}) {
  const { upload, getUserId, broadcastToUsers, notificationService } = helpers;
